...
class Collect_artist_songs:
    ...
    def get_authors(self):
        ...
        #artists.to_csv(self.path + 'cleaned_artists.csv')
        ...
        f = open(self.path + self.outputfile, 'a')
                ...
                if artist_songs is not None:# check if object is empty
                    ...
                    try:
                        ...
                        for i in artist_songs.songs:
                            ...
                            with open(self.path + '{}.json'.format(self.outputfile), 'a') as fjson:
...
outputfile = 'songs_year.csv'#name of the song file
#artist_list_path = 'artist_list_rap_US_filtered3.csv'
artist_list_path = 'cleaned_artists.csv'
genius_client_access_token = experiment['token'][2]
